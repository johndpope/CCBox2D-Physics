...
- (ATNode *) addNode:(NSString *)name withData:(NSMutableDictionary *)data  withWorld:(b2World *)world
{
    ...
    if (priorNode != nil) {
        ...
        NSLog(@"Overwrote user data for a node: %@ :%@... Be sure this is what you wanted.",priorNode.name,name);
        ...
        ATParticle *node = [[ATParticle alloc] initWithWorld:world size:1 position:pt angle:0.35  name:name userData:data];
...
- (ATEdge *) addEdgeFromNode:(NSString *)source toNode:(NSString *)target withData:(NSMutableDictionary*)data   withWorld:(b2World *)world
{
    NSParameterAssert(source != nil);
    NSParameterAssert(target != nil);
    NSParameterAssert(world != nil);
    ...
    if (sourceNode == nil) {
        ...
        sourceNode = [self addNode:source withData:nil withWorld:world];
    ...
    if (targetNode == nil) {
        ...
        targetNode = [self addNode:target withData:nil withWorld:world];
